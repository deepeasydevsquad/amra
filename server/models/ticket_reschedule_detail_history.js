...
module.exports = (sequelize, DataTypes) => {
  class Ticket_reschedule_detail_history extends Model {
    ...
    static associate(models) {
      ...
      Ticket_reschedule_detail_history.belongsTo(models.Ticket_reschedule_history, {
        foreignKey: "ticket_reschedule_history_id",
      });

      Ticket_reschedule_detail_history.belongsTo(models.Ticket_transaction_detail, {
  ...
  Ticket_reschedule_detail_history.init({
    ...
    old_code_booking: DataTypes.INTEGER,
