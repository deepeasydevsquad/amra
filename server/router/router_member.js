...
const validationParam = require("../validation/param");
const {
  validateMember,
  upload,
  uploadExcel,
  ...
  check_level_agen,
  check_upline,
} = require("../validation/member"); // Pastikan ini adalah class
...
router.get(
  "/member/get-daftar-cabang",
  authenticateToken,
  controllers.getDaftarCabang
);
...
router.post(
  ...
  [
    ...
    body("level")
      .trim()
      .notEmpty()
      .withMessage("Level Agen tidak boleh kosong.")
      .custom(check_level_agen),
    body("upline")
      .trim()
      .notEmpty()
      .withMessage("Upline tidak boleh kosong.")
      .custom(check_upline),
  ],
...
router.post(
  ...
  [
    body("cabang_id")
      ...
      .custom(validationParam.check_cabang_id),
  ],
  controllers.importExcel
);
