...
class Model_cud {
  ...
  async get_nomor_akun_aset(company_id) {
    ...
    while (condition) {
      num++;
      var check = await Akun_secondary.findOne({
        where: { nomor_akun: num, company_id: company_id },
      });
  ...
  async add() {
    ...
    try {
      ...
      const nomor_akun_pendapatan = await this.get_nomor_akun_pendapatan(
        this.company_id
      );
  ...
  async update() {
    ...
    try {
      ...
      const infoFasilitas = await model_r.infoFasilitas(
        body.id,
        this.company_id
      );
  ...
  async delete() {
    ...
    try {
      ...
      const qA = await Akun_secondary.findOne({
