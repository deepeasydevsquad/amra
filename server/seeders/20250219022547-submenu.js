...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('Submenus', [
      ...
      { menu_id : menus[3].id, name: 'Daftar Agen', path: 'daftar_agen', tab:`[{"id":"${tabs[26].id}"}]`,  createdAt: new Date(), updatedAt: new Date() },
      ...
      { menu_id : menus[5].id, name: 'Daftar Provider Visa', path: 'daftar_provider_visa', tab:`[{"id":"${tabs[11].id}"}]`,  createdAt: new Date(), updatedAt: new Date() },
      { menu_id : menus[5].id, name: 'Daftar Asuransi', path: 'daftar_asuransi', tab:`[{"id":"${tabs[45].id}"}]`,  createdAt: new Date(), updatedAt: new Date() },
