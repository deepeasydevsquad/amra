...
const selectedProvinsi = ref(null) // Buat nampilin nama provinsi yang dipilih
...
const fetchKabupaten = async (provinsiId) => {
  try {
    ...
    console.log('Kabupaten data:', kabupatenList.value)
  } catch (error) {
