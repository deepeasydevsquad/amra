  ...
  <div class="min-h-screen bg-gray-50 flex items-center justify-center px-4">
    <div class="bg-white shadow-lg rounded-2xl p-8 w-full max-w-2xl">
      ...
      <p class="text-gray-500 mb-6">
        Lengkapi informasi cabang utama untuk memulai menggunakan sistem.
      </p>
      ...
      <button
        @click="saveForm"
        class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg shadow-sm transition-all duration-200"
      >
        Simpan Cabang
      </button>
    </div>
