...
import { getKwitansiHandoverFasilitas } from '@/service/invoice.ts'
...
const fetchData = async () => {
  try {
    ...
    const response = await getKwitansiHandoverFasilitas(invoice.toString())
...
<template>
  ...
  <div class="bg-white p-8 text-xs text-gray-900 min-h-screen">
