<template>
  <Form :form-status="isOpen" :label="'Tambah Grup Baru'" width="sm:w-full sm:max-w-md" @close="closeModal" @cancel="closeModal"  @submit="saveGroup" :submitLabel="'TAMBAH GRUP'">
