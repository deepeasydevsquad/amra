...
// Import Icon
import DeleteIcon from '@/components/User/Modules/DaftarBank/Icon/DeleteIcon.vue'
import EditIcon from '@/components/User/Modules/DaftarBank/Icon/EditIcon.vue'
...
import Form from '@/components/User/Modules/DaftarBank/Widget/Form.vue'
import PrimaryButton from '@/components/Button/PrimaryButton.vue'
import LightButton from "@/components/Button/LightButton.vue"
import Pagination from '@/components/Pagination/Pagination.vue'

// Import service API
import { daftarBank, deleteBank } from '@/service/daftar_bank'; // Import function POST
  ...
  <div class="container mx-auto p-4">
    ...
    >
      <Form
        ...
        @status="(payload) => displayNotification(payload.err_msg || 'Tambah atau Update Bank gagal', payload.error ? 'error' : 'success')"
      />
    </Transition>
