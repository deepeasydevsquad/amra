      ...
      <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
        <thead class="bg-gray-50">
          <tr class="bg-gray-100">
            <th class="w-[12%] px-6 py-4 font-medium font-bold text-gray-900 text-center">Nomor Identitas</th>
            <th class="w-[23%] px-6 py-4 font-medium font-bold text-gray-900 text-center">Nama Jamaah</th>
            ...
            <th class="w-[15%] px-6 py-4 font-medium font-bold text-gray-900 text-center">Jumlah Pembelian Paket</th>
