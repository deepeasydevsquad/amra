...
<template>
  <Form :form-status="showStatus" :label="'Perbaharui Data Saldo Akun' " @close="closeModal" @cancel="closeModal" @submit="save"
    width="sm:w-full sm:max-w-md" :submitLabel="'PERBAHARUI SALDO AKUN'">
    <div class="space-y-4">
      <div>
