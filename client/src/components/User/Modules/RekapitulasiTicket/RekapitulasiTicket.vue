...
// import element
import Notification from '@/components/User/Modules/RekapitulasiTicket/Particle/Notification.vue'
import Confirmation from '@/components/User/Modules/RekapitulasiTicket/Particle/Confirmation.vue'

// import widget
import FormAdd from '@/components/User/Modules/RekapitulasiTicket/Widget/FormAdd.vue'
      ...
      <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
        <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
          <thead class="bg-gray-50">
            <tr>
              <th class="w-[20%] px-6 py-4 font-medium font-bold text-gray-900 text-center">Nomor Rekapitulasi</th>
              <th class="w-[40%] px-6 py-4 font-medium font-bold text-gray-900 text-center">Info Rekapitulasi</th>
              <th class="w-[20%] px-6 py-4 font-medium font-bold text-gray-900 text-center">Total</th>
              <th class="w-[10%] px-6 py-4 font-medium font-bold text-gray-900 text-center">Tanggal Transaksi</th>
