...
<template>
  ...
  <Form :form-status="isModalOpen" :label="formData?.id === 0 ? 'Tambah Investor Baru' : 'Edit Data Investor'" @close="handleCancel" @cancel="handleCancel" @submit="saveData" width="sm:w-full sm:max-w-xl" :submitLabel="formData?.id === 0 ? 'TAMBAH INVESTOR' : 'PERBAHARUI INVESTOR'">
    <div class="space-y-4">
      <div >
