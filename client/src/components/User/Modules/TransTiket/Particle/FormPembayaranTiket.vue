...
<template>
  <Form :form-status="formStatus" :label="'Pembayaran Tiket'" :submitLabel="'BAYAR'" :width="'w-1/4'" @close="handleCancel" @cancel="handleCancel" @submit="handleSubmit">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-0 pr-3">
      ...
      <InputCurrency class="mt-0 md:col-span-2" label="Nominal Bayar" id="nominal" placeholder="Nominal Bayar" v-model="form.dibayar" :error="errors.dibayar"/>
      ...
      <div class="md:col-span-2 mt-0">
        ...
        <div id="sisa" class=" text-gray-800 px-3 py-2 mt-1 rounded border " :class=" typeof calculateSisa != 'number' ? 'text-red italic bg-red-100 border-red-300' : ' bg-gray-100 border-gray-300' ">
