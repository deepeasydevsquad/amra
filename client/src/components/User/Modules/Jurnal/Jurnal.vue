...
// Import Icon
import DeleteIcon from '@/components/User/Modules/Jurnal/Icon/DeleteIcon.vue'
  ...
  <div class="container mx-auto p-4">
    ...
    <div class="flex justify-end items-center mb-4">
      ...
      <div class="inline-flex rounded-md shadow-xs" role="group">
          ...
          />
          <select  v-model="selectedOptionPeriode" style="width: 300px;"  @change="fetch()" class="bg-white border-t border-b border-gray-300 text-gray-900 text-sm rounded-s-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
              <option v-for="optionA in optionFilterPeriode" :key="optionA.id" :value="optionA.id">
                {{ optionA.name }}
              </option>
          </select>
          <select  v-model="selectedOptionCabang" style="width: 300px;" @change="fetch()" class="bg-white border-gray-300 text-gray-900 text-sm rounded-e-lg border-t border-b border-e focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
      <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
        <thead class="bg-gray-100">
          <tr>
            <th class="w-[10%] px-6 py-3 font-medium text-gray-900 border text-center align-bottom" rowspan="2">Tanggal Transaksi</th>
            <th class="w-[15%] px-6 py-3 font-medium text-gray-900 border text-center align-bottom" rowspan="2">Ref</th>
            <th class="w-[15%] px-6 py-3 font-medium text-gray-900 border text-center align-bottom" rowspan="2">Keterangan</th>
            <th class="w-[40%] px-6 py-3 font-medium text-gray-900 border text-center align-bottom" colspan="4">Akun</th>
            <th class="w-[15%] px-6 py-3 font-medium text-gray-900 border text-center align-bottom"  rowspan="2">Saldo</th>
            <th class="w-[5%]  px-6 py-3 font-medium text-gray-900 border text-center align-bottom"  rowspan="2">Aksi</th>
          </tr>
          <tr>
            <th class="w-[20%] px-6 py-3 font-medium text-gray-900 border text-center align-bottom" colspan="2">Debet</th>
            <th class="w-[20%] px-6 py-3 font-medium text-gray-900 border text-center align-bottom" colspan="2">Kredit</th>
          </tr>
        </thead>
          ...
          <template v-if="dataJurnal && dataJurnal.length > 0">
            <tr v-for="jurnal in dataJurnal" :key="jurnal.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 text-center">
                ...
                <template v-else>
                  <span class="text-gray-500" style="font-size: 13px;"> <i>Tidak dapat dihapus</i> </span>
                </template>
              </td>
            </tr>
          </template>
          <tr v-else>
            <td colspan="9" class="px-6 py-4 text-center text-base text-gray-600">Daftar jurnal tidak ditemukan.</td>
          </tr>
        </tbody>
