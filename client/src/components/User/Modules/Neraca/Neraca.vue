...
<template>
  <div class="container mx-auto p-4">
    ...
    <!-- Table data -->
    <!-- <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md gab-2">
    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md gap-2 flex">
      <div class="w-1/2  p-4">
        <table class="w-full border-collapse bg-white text-left text-sm text-gray-500" >
          ...
          <tbody class="divide-y divide-gray-100 border-t border-gray-100">
            <tr>
              <td class="w-[10%] px-6 py-4 border text-left text-xs ">11010</td>
              <td class="w-[30%] px-6 py-4 border text-left text-xs ">KAS</td>
              <td class="px-6 py-4 border text-left text-xs ">Rp 63,080,000</td>
            </tr>
            <tr>
              <td class="w-[10%] px-6 py-4 border text-left text-xs ">11020</td>
              <td class="w-[30%] px-6 py-4 border text-left text-xs ">BANK</td>
              <td class="px-6 py-4 border text-left text-xs ">Rp 0</td>
            </tr>
          </tbody>
          <tfoot>
            <tr class="bg-gray-50">
      ...
      <div class="w-1/2 bg-green-100 p-4">
        Kolom 2
      </div>
    </div>
