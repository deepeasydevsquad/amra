...
<template>
        ...
        <table ref="tabelutama" class="w-full border-collapse bg-white text-left text-sm text-gray-500">
          <thead class="bg-gray-100">
            <tr>
              ...
              <th :class="filter === 'sudah_beli_paket' ? 'w-[75%]' : 'w-[70%]'" class="px-6 py-3 font-medium text-gray-900 text-center">Info Deposit</th>
              <th class="w-[5%] px-6 py-3 font-medium text-gray-900 text-center" v-if="filter === 'belum_beli_paket'">Aksi</th>
            </tr>
          </thead>
  ...
  >
    <FormOpsiHandoverBarang
      ...
      @terima-barang="isFormOpsiHandoverBarangOpen = false; openTerimaBarangHandover(tabunganId)"
      @pengembalian-barang="isFormOpsiHandoverBarangOpen = false; openPengembalianBarangHandover(tabunganId)"
      />
  </transition>
