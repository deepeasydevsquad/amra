...
<template>
  ...
  <div v-if="props.isFormBeliPaketUmrahOpen && !isLoading" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      ...
      <div class="relative p-6 inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:align-middle">
        <div class="bg-white">
          ...
          <div class="space-y-4 text-gray-800">
            <div class="mb-2">
              <label class="block text-md font-medium text-gray-700 mb-1">Informasi Tabungan Umrah</label>
              <div class="p-3 border border-gray-200 rounded-md bg-gray-50">
                <p class="text-gray-600">
                  Total Tabungan: <strong>Rp {{ Mst_paket_type?.total_tabungan.toLocaleString() }}</strong>
                </p>
                <p class="text-gray-600">
            ...
            <div class="overflow-x-auto rounded-lg overflow-y-auto scroll-smoothTipe Paket shadow-md max-h-[36vh] border mb-4">
