...
<template>
  ...
  <div v-if="props.isFormAddHandoverOpen && !isLoading" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex min-h-screen items-end justify-center px-6 pt-6 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="relative p-6 inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl sm:align-middle">
        <div class="bg-white">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="space-y-4">
                <div class="space-y-2">
                  ...
                  />
                  <p v-if="errors.nama_penerima" class="mt-1 text-sm text-red-600">{{ errors.nama_penerima }}</p>
                </div>
                <div class="space-y-2">
                  <label class="block text-sm font-medium text-gray-700">
                  ...
                  />
                  <p v-if="errors.nomor_identitas_penerima" class="mt-1 text-sm text-red-600">{{ errors.nomor_identitas_penerima }}</p>
                </div>
              </div>
