  ...
  <div v-if="!isLoading && data">
    <div class="bg-white p-8 text-sm print:text-[12px] text-gray-800 min-h-screen space-y-2">
      ...
      <div class="flex items-center">
        ...
        <div class="flex border border-gray-900 flex-grow">
          <div class="flex-1 border-r border-gray-900 flex items-center justify-center">
          ...
          <div class="flex-1 flex items-center justify-center">
            <span class="text-gray-500">TELPON/HP</span>
          </div>
        </div>
      </div>
